...
## Инструкция
### Скачать архив с кодом, распаковать, занести в среду visual studio code. В терминале написать npm install и после установки пакетов написать npm run dev. Запуститься и серверная часть, и клиентская.
